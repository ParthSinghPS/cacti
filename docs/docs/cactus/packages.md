...
## Developer Packages (Consuming Cacti)
...
## Operator Packages (Deploying Cacti)
...
| [cactus-plugin-ledger-connector-aries](https://github.com/hyperledger-cacti/cacti/tree/main/packages/cactus-plugin-ledger-connector-aries) | Standardized connector for interacting with Hyperledger Aries. |
...
| [cactus-plugin-ledger-connector-cdl](https://github.com/hyperledger-cacti/cacti/tree/main/packages/cactus-plugin-ledger-connector-cdl) | Standardized connector for interacting with CDL networks. |
...
| [cactus-plugin-ledger-connector-polkadot](https://github.com/hyperledger-cacti/cacti/tree/main/packages/cactus-plugin-ledger-connector-polkadot) | Standardized connector for interacting with Polkadot networks. |
| [cactus-plugin-ledger-connector-sawtooth](https://github.com/hyperledger-cacti/cacti/tree/main/packages/cactus-plugin-ledger-connector-sawtooth) | Standardized connector for interacting with Hyperledger Sawtooth. |
...
| [cactus-plugin-keychain-aws-sm](https://github.com/hyperledger-cacti/cacti/tree/main/packages/cactus-plugin-keychain-aws-sm) | Keychain plugin for secure credential storage using AWS Secrets Manager. |
| [cactus-plugin-keychain-azure-kv](https://github.com/hyperledger-cacti/cacti/tree/main/packages/cactus-plugin-keychain-azure-kv) | Keychain plugin for secure credential storage using Azure Key Vault. |
| [cactus-plugin-keychain-google-sm](https://github.com/hyperledger-cacti/cacti/tree/main/packages/cactus-plugin-keychain-google-sm) | Keychain plugin for secure credential storage using Google Secret Manager. |
